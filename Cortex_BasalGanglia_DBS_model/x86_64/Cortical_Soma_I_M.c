...
#define dt _nt->_dt
#define i_M _p[0]
#define i_M_columnindex 0
#define g_M _p[1]
#define g_M_columnindex 1
#define p _p[2]
#define p_columnindex 2
#define ik _p[3]
#define ik_columnindex 3
#define p_inf _p[4]
#define p_inf_columnindex 4
#define tau_p _p[5]
#define tau_p_columnindex 5
#define Dp _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 cortical_soma_i_m /home/people/22213094/CBG_Model_Fleming_PTS/Cortex_BasalGanglia_DBS_model/Cortical_Soma_I_M.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/people/22213094/CBG_Model_Fleming_PTS/Cortex_BasalGanglia_DBS_model/Cortical_Soma_I_M.mod";
static const char* nmodl_file_text = 
