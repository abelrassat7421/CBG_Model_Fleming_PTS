...
#define dt _nt->_dt
#define i_Kv _p[0]
#define i_Kv_columnindex 0
#define g_Kv _p[1]
#define g_Kv_columnindex 1
#define n _p[2]
#define n_columnindex 2
#define ik _p[3]
#define ik_columnindex 3
#define alpha_n _p[4]
#define alpha_n_columnindex 4
#define beta_n _p[5]
#define beta_n_columnindex 5
#define n_inf _p[6]
#define n_inf_columnindex 6
#define tau_n _p[7]
#define tau_n_columnindex 7
#define Dn _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 cortical_axon_i_kv /home/people/22213094/CBG_Model_Fleming_PTS/Cortex_BasalGanglia_DBS_model/Cortical_Axon_I_Kv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/people/22213094/CBG_Model_Fleming_PTS/Cortex_BasalGanglia_DBS_model/Cortical_Axon_I_Kv.mod";
static const char* nmodl_file_text = 
